    ...
    <div class="w-full max-w-md">
        <div class="bg-white shadow-xl rounded-2xl overflow-hidden">
            <div class="bg-[rgb(255,110,55)] px-8 py-6 text-center">
                ...
                <h1 class="text-xl font-bold text-white">Queue Request</h1>
                <p class="text-white/80 text-sm">Fill in your details below</p>
            </div>
            <div class="p-8">
                ...
                <form method="post" id="frmUserForm">
                    ...
                    <div class="mb-4">
                        <label for="transaction-history-student" class="block text-sm font-medium text-gray-700 mb-1">Are you a student?</label>
                        <div class="relative">
                            <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400"><i class="bi bi-mortarboard-fill"></i></span>
                            <select name="transaction-history-student" id="transaction-history-student" class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[rgb(255,110,55)] focus:border-transparent outline-none bg-white appearance-none">
                    ...
                    <p class="text-gray-500 text-sm text-center mt-4">
                        Need priority service? <a href="./requester_form_priority.php" class="text-[rgb(255,110,55)] hover:underline font-medium">Use Priority Form</a>
                    </p>
                </form>
                <?php else :?>
