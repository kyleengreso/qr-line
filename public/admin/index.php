                        ...
                        <div class="col-lg-12 col-xl-6 m-0 p-0">
                            <div class="card shadow m-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="w-100">
                                        <a class="btn btn-primary" href="/public/employees/" style="width:100%">View all employees</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card shadow m-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="width:100%">
                                        ...
                                        <a class="btn btn-primary" href="/public/counters" style="width:100%">View all counters</a>
                                </div>
                            </div>
                        </div>
                </div>
