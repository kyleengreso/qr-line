...
<body>
    ...
    <div class="col-12 col-md-10 col-lg-8 mx-auto max-w-900">
            ...
            <div class="card shadow transactions-card">
                ...
                <div class="card-body position-relative">
                    ...
                    <div id="employeesOverlay" class="d-none loader-overlay"><div><div class="spinner-border" style="color:#ff7f00;" role="status" aria-hidden="true"></div><div class="small text-muted mt-2">Loading...</div></div></div>
                    <div class="d-flex justify-content-between align-items-center mt-3">
                        ...
                        <div id="employeesLoader" class="d-none">
                            <div class="spinner-border" style="color:#ff7f00;" role="status" aria-hidden="true"></div>
    ...
    const perPageSelect = document.getElementById('employeesPerPage');
        ...
        function showEmployeesLoading() {
            ...
            if (tbody) {
                tbody.innerHTML = `<tr><td colspan="5" class="text-center py-4" id="employeesLoading"><div class="spinner-border" style="color:#ff7f00;" role="status"></div></td></tr>`;
                return;
            }
            ...
            employeesList.innerHTML = `
                <div class="col-12 text-center py-4" id="employeesLoading">
                    <div class="spinner-border" style="color:#ff7f00;" role="status">
                ...
                beforeSend: function(xhr) {
                    ...
                    try {
                        ...
                        if (btn) {
                            ...
                            btn.innerHTML = '<span class="spinner-border spinner-border-sm me-2" style="color:#ff7f00;" role="status" aria-hidden="true"></span>Saving...';
                        }
                    } catch (e) {}
                },
                success: function (response) {
                ...
                beforeSend: function(xhr) {
                    ...
                    try {
                        ...
                        if (btn) {
                            btn.disabled = true;
                            btn.dataset.prevLabel = btn.innerHTML;
                            btn.innerHTML = '<span class="spinner-border spinner-border-sm me-2" style="color:#ff7f00;" role="status" aria-hidden="true"></span>Deleting...';
                        }
                    } catch (e) {}
                },
                success: function (response) {
        ...
        (function() {
            ...
            function setLoadingBtn(btn, label) {
                ...
                btn.disabled = true;
                btn.innerHTML = '<span class="spinner-border spinner-border-sm me-2" style="color:#ff7f00;" role="status" aria-hidden="true"></span>' + label;
            }
