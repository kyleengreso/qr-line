...
-- Dumping database structure for if0_38978912_qr_queue_system
CREATE DATABASE IF NOT EXISTS `if0_38978912_qr_queue_system` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `if0_38978912_qr_queue_system`;

-- Dumping structure for table if0_38978912_qr_queue_system.counters
...
-- Dumping structure for procedure if0_38978912_qr_queue_system.employeeMonitor
DELIMITER //
...
-- Dumping structure for event if0_38978912_qr_queue_system.employeeMonitorEvent
DELIMITER //
...
-- Dumping structure for table if0_38978912_qr_queue_system.employees
...
-- Dumping structure for procedure if0_38978912_qr_queue_system.requesterCount
DELIMITER //
...
-- Dumping structure for table if0_38978912_qr_queue_system.requesters
...
-- Dumping structure for table if0_38978912_qr_queue_system.scheduler
...
-- Dumping structure for table if0_38978912_qr_queue_system.setup_system
...
-- Dumping structure for event if0_38978912_qr_queue_system.TransactionHistoryStatsEvent
DELIMITER //
...
-- Dumping structure for table if0_38978912_qr_queue_system.transactions
...
-- Dumping structure for procedure if0_38978912_qr_queue_system.TransactionsHistoryStats
DELIMITER //
...
-- Dumping structure for procedure if0_38978912_qr_queue_system.TransactionsToday
DELIMITER //
...
-- Dumping structure for event if0_38978912_qr_queue_system.TransactionsTodayEvent
DELIMITER //
...
-- Dumping structure for table if0_38978912_qr_queue_system.user_logs
...
-- SCHEDULER DEFAULT --
INSERT INTO scheduler (schedule_key, time_start, time_end, schedule_type, `repeat`, `everyday`, `enable`) 
                        VALUES ('requester_form', '08:00:00', '17:00:00', 'requester', 'daily', 'mon;tue;wed;thu;fri', 1);
 
-- DEFAULT ACCOUNT --                       
INSERT INTO employees (username, password, role_type, email, active, attempt_login) 
VALUES ('root', '$2y$10$iG3rSR79iDdnu7cEU1U5Wu8GpDAadyvUnsRvCLWTRayHYnSJSliIW','admin', 'root@localhost.com', 1, 3);

-- DEFAULT SETUP_SYSTEM --
DELETE FROM `setup_system`;
ALTER TABLE `setup_system` AUTO_INCREMENT = 1;
INSERT INTO `setup_system` (`setup_id`, `setup_key`, `setup_value`, `setup_value_int`, `setup_description`, `updated_at`) VALUES
	...
	(12, 'transactions_total', NULL, 8, 'Count of total transactions', '2025-05-13 13:55:00'),
	(13, 'transactions_yesterday', NULL, 0, 'Count of transactions yesterday', '2025-05-11 19:38:01'),
	(14, 'transactions_this_week', NULL, 5, 'Count of transactions this week', '2025-05-13 13:55:00'),
	(15, 'transactions_this_month', NULL, 8, 'Count of transactions this month', '2025-05-13 13:55:00'),
	(16, 'transactions_this_year', NULL, 8, 'Count of transactions this year', '2025-05-13 13:55:00'),
	(17, 'transactions_today', NULL, 5, 'Count of transactions this day', '2025-05-13 13:54:04'),
	(18, 'transactions_today_pending', NULL, 0, 'Count of pending transactions this day', '2025-05-13 14:31:29'),
	(19, 'transactions_today_completed', NULL, 3, 'Count of completed transactions this day', '2025-05-13 14:31:04'),
	(20, 'transactions_today_cancelled', NULL, 1, 'Count of cancelled transactions this day', '2025-05-13 14:46:54'),
